                        ...
                        <div class="bs-stepper-header px-0" role="tablist">
                            <div class="step" data-target="#account-details" role="tab" id="account-details-trigger">
                                <button type="button" class="step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        ...
                                        <span class="bs-stepper-subtitle">Masukkan Data User</span>
                                    </span>
                                </button>
                            </div>
                            <div class="line">
                            ...
                            <div class="step" data-target="#personal-info" role="tab" id="personal-info-trigger">
                                <button type="button" class="step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title">Verifikasi Nomor</span>
                                        <span class="bs-stepper-subtitle">Masukkan Nomor Telepon</span>
                                    </span>
                                </button>
                            </div>
                            <div class="line">
                            ...
                            <div class="step" data-target="#billing" role="tab" id="billing-trigger">
                                <button type="button" class="step-trigger">
                                    ...
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title">Permintaan Akses</span>
                                        <span class="bs-stepper-subtitle">Tentukan Role</span>
                                    </span>
                                </button>
                            </div>
                        </div>

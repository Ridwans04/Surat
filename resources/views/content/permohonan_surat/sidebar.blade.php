  ...
  <div class="email-app-menu">
    <div class="form-group-compose text-center compose-btn">
      <button
        ...
        data-bs-target="#buat_permohonan_surat"
        style="background-color: rgba(26, 185, 98, 0.856)"
      >
        Buat Permintaan
      </button>
    </div>
    <div class="sidebar-menu-list">
      <div class="list-group list-group-messages">
        <a href="#" class="list-group-item list-group-item-action active">
          ...
          <span class="align-middle">Permintaan masuk</span>
        ...
        <a href="#" class="list-group-item list-group-item-action">
          ...
          <span class="align-middle">Permintaan koreksi</span>
          <span class="badge badge-light-warning rounded-pill float-end">2</span>
        </a>
        <a href="#" class="list-group-item list-group-item-action">
          <i data-feather="send" class="font-medium-3 me-50"></i>
          <span class="align-middle">Permintaan selesai</span>
        </a>
        <a href="#" class="list-group-item list-group-item-action">
          <i data-feather="star" class="font-medium-3 me-50"></i>
          <span class="align-middle">Penting</span>
        </a>
        <a href="#" class="list-group-item list-group-item-action">
          <i data-feather="trash" class="font-medium-3 me-50"></i>
          <span class="align-middle">Permintaan ditolak</span>
          <span class="badge badge-light-danger rounded-pill float-end">5</span>
        </a>
      </div>
      <!-- <hr /> -->
      <h6 class="section-label mt-3 mb-1 px-2">Pembuat Permintaan</h6>
      <div class="list-group list-group-labels cursor-pointer" id="list_pj">
      </div>
    </div>
  </div>
</div>
